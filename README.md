...
```bash
PROXY_IMAGE=ghcr.io/yinghuo202-rgb/task-platform-proxy:v1.4.1
WEB_IMAGE=ghcr.io/yinghuo202-rgb/task-platform-web:v1.4.1
API_IMAGE=ghcr.io/yinghuo202-rgb/task-platform-api:v1.4.1
```
...
v1.4.1 精简手帐为“时光流”和“翻页看”两种视图；修复纵轴快速拖动后详情可能停留在加载状态的问题，并为翻页视图增加左右滑动、方向键和上下篇按钮。
