...
- 轻量个人待办保存在数据库中，可记录备注、完成状态与时间；电脑端可拖入日历排期，手机端可直接选择时间。
...
- `calendar_todos`（个人待办、备注、排期与完成时间）
...
v1.23.0 在首页日历加入私有个人待办抽屉，支持备注、完成记录、手动排期及桌面端拖入日历；同时把日程备注直接呈现在月、周、日和当天安排中，常用入口保持紧凑。
