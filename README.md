...
```bash
PROXY_IMAGE=ghcr.io/yinghuo202-rgb/task-platform-proxy:v1.6.1
WEB_IMAGE=ghcr.io/yinghuo202-rgb/task-platform-web:v1.6.1
API_IMAGE=ghcr.io/yinghuo202-rgb/task-platform-api:v1.6.1
```
