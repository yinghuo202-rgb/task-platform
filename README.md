...
```bash
PROXY_IMAGE=ghcr.io/yinghuo202-rgb/task-platform-proxy:v1.14.0
WEB_IMAGE=ghcr.io/yinghuo202-rgb/task-platform-web:v1.14.0
API_IMAGE=ghcr.io/yinghuo202-rgb/task-platform-api:v1.14.0
```
