...
```bash
PROXY_IMAGE=ghcr.io/yinghuo202-rgb/task-platform-proxy:v1.13.0
WEB_IMAGE=ghcr.io/yinghuo202-rgb/task-platform-web:v1.13.0
API_IMAGE=ghcr.io/yinghuo202-rgb/task-platform-api:v1.13.0
```
...
v1.13.0 移除任务分类和预设奖励选项，任务奖励改为自由填写，并新增“奖励”页面统计当前用户已完成接取任务的奖励记录。
